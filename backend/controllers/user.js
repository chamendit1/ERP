...
export const signup = async (req, res)=> {
    const { email, password, confirmPassword, firstName, lastName, role, access} = req.body
    // console.log(role)
    try {
        const existingUser = await User.findOne({ email })
        ...
        const result = await User.create({ email, password: hashedPassword, name: `${firstName} ${lastName}`, role, access })
