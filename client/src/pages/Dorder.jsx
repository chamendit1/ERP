...
const Dorder = ({ setOpen, open, currentId, setCurrentId }) => {
  ...
  const handleClose = () => {
    ...
    return (
      <Dialog onClose={handleClose} open={open} maxWidth='md' fullWidth>
        ...
        <Button onClick={createAndDownloadPdf}>Generate Surat Jalan</Button>
          ...
          <Container  className={classes.headerContainer}>
              ...
              : (
                  ...
                  <Grid item style={{marginRight: 40, textAlign: 'right'}}>
                      <Typography style={{lineSpacing: 1, fontSize: 45, fontWeight: 700, color: 'gray'}} >Surat Jalan</Typography>
