                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left" onClick={() => openClient(row._id)}>{moment(row.datePaid).format('Do MMM YY')}</TableCell>
                      <TableCell align="left" onClick={() => openClient(row._id)}>{row.note}</TableCell>
                      <TableCell align="left" onClick={() => openClient(row._id)}>{row.amountPaid}</TableCell>
                      <TableCell align="left" onClick={() => openClient(row._id)}>{row.paymentMethod}</TableCell>
                      <TableCell align="left" onClick={() => openClient(row._id)}>{row.paymentCategory}</TableCell>
